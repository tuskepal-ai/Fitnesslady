// FILE: /de/shared/firebase.js
// Firebase v9 modular (CDN) — ÉLES shared helpers DE
...
export function toLogin(lang="de"){
  const l = (lang === "hu") ? "hu" : "de";
  window.location.href = `${BASE_PREFIX}/${l}/login/`;
}
export function toApp(lang="de"){
  const l = (lang === "hu") ? "hu" : "de";
  window.location.href = `${BASE_PREFIX}/${l}/app/`;
}
export function toAdmin(lang="de"){
  const l = (lang === "hu") ? "hu" : "de";
